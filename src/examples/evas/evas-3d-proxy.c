...
_on_canvas_resize(Ecore_Evas *ee)
{
   ...
   efl_gfx_object_size_set(background, EINA_SIZE2D(w,  h));
   efl_gfx_object_size_set(image, EINA_SIZE2D(w,  h));
}
...
main(void)
{
   ...
   efl_gfx_object_size_set(background, EINA_SIZE2D(WIDTH,  HEIGHT));
   efl_gfx_object_visible_set(background, EINA_TRUE);
   ...
   efl_gfx_object_position_set(source, EINA_POSITION2D((WIDTH / 2), (HEIGHT / 2)));
   efl_gfx_object_size_set(source, EINA_SIZE2D((WIDTH / 2),  (HEIGHT / 2)));
   efl_gfx_object_visible_set(source, EINA_TRUE);
#else
   ...
   efl_gfx_object_size_set(image, EINA_SIZE2D((WIDTH / 2),  (HEIGHT / 2)));
   efl_gfx_object_visible_set(image, EINA_TRUE);
