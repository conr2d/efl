...
_anim_cb(void *data)
{
   ...
   EINA_SIZE2D(w, h) = efl_gfx_object_size_get(o);
   efl_gfx_map_reset(o);
   efl_gfx_map_smooth_set(o, ad->smooth);
   efl_gfx_map_alpha_set(o, ad->alpha);
   efl_gfx_map_color_set(o, -1, r, g, b, a);
   ...
   if (ad->backface_culling)
     efl_gfx_object_visible_set(o, efl_gfx_map_clockwise_get(o));
   else
     efl_gfx_object_visible_set(o, 1);


   o = evas_object_name_find(ad->canvas, "obj4");
   rect = efl_gfx_object_geometry_get(o);
   efl_gfx_map_reset(o);
   efl_gfx_map_smooth_set(o, ad->smooth);
   efl_gfx_map_alpha_set(o, ad->alpha);
