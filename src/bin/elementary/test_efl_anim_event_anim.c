...
test_efl_anim_event_anim(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   efl_canvas_object_event_animation_set(btn, EFL_GFX_OBJECT_EVENT_SHOW, show_anim);
   ...
   efl_canvas_object_event_animation_set(btn, EFL_GFX_OBJECT_EVENT_HIDE, hide_anim);
