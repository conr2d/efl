...
_custom_layout_update(Eo *pack, void *_pd EINA_UNUSED)
{
   ...
   g = efl_gfx_object_geometry_get(pack);
        ...
        if (efl_pack_table_position_get(pack, item, &c, &r, &cs, &rs))
          {
             ...
             efl_gfx_object_geometry_set(item, m);
...
test_ui_table(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   efl_gfx_object_size_set(win, EINA_SIZE2D(600,  400));
   ...
   efl_pack(vbox, f);
   efl_gfx_object_visible_set(f, 1);
   ...
   efl_gfx_object_visible_set(table, 1);
   ...
   efl_gfx_object_visible_set(win, 1);
}
                    ...
                    void *event_info EINA_UNUSED)
{
   ...
   efl_gfx_size_hint_margin_set(vbox, 5, 5, 5, 5);
   elm_win_resize_object_add(win, vbox);
   efl_gfx_object_visible_set(vbox, 1);
   ...
   efl_gfx_object_visible_set(hbox, 1);
   ...
   efl_gfx_size_hint_weight_set(bx, 1, 1);
   efl_pack(hbox, bx);
   efl_gfx_object_visible_set(bx, 1);
