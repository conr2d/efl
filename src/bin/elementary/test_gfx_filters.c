...
_text_resize(void *data EINA_UNUSED, const Efl_Event *ev)
{
   ...
   sz = efl_gfx_object_size_get(ev->object);
...
test_gfx_filters(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
...

   {
      ...
      efl_event_callback_add(o, EFL_GFX_OBJECT_EVENT_RESIZE, _textblock_resize, NULL);
      ...
      efl_gfx_object_scale_set(o, elm_config_scale_get());
      efl_pack(box2, o);
   ...
   efl_gfx_object_size_set(win, EINA_SIZE2D(500,  600));
}
