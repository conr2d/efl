...
test_ui_textpath(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   efl_gfx_object_visible_set(box, EINA_TRUE);
   ...
   efl_gfx_object_visible_set(hbox, EINA_TRUE);
   ...
   efl_gfx_object_visible_set(chk, EINA_TRUE);
   ...
   efl_gfx_object_visible_set(sld, EINA_TRUE);
   angle_sld = sld;
   ...
   efl_gfx_object_visible_set(btn, EINA_TRUE);

   elm_win_resize_object_add(win, box);
   efl_gfx_object_size_set(win, EINA_SIZE2D(400,  400));
