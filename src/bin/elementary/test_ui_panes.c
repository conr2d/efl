...
test_panes_minsize(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   ...
   win = efl_add(EFL_UI_WIN_CLASS, efl_main_loop_get(),
                 ...
                 efl_text_container_text_set(efl_added, "Efl.Ui.Panes"),
   ...
   efl_add(EFL_UI_BUTTON_CLASS, win,
           efl_text_container_text_set(efl_added, "Left - user set min size(110,110)"),
   ...
   efl_add(EFL_UI_BUTTON_CLASS, win,
           efl_text_container_text_set(efl_added, "Up - user set min size(10,0)"),
   ...
   efl_add(EFL_UI_BUTTON_CLASS, win,
           efl_text_container_text_set(efl_added, "Down - min size 50 40"),
