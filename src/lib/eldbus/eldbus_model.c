...
_eldbus_model_connection_get(Eo *obj EINA_UNUSED, Eldbus_Model_Data *pd)
{
...
static const char *
_eldbus_model_address_get(Eo *obj EINA_UNUSED, Eldbus_Model_Data *pd)
{
   return pd->address;
}

static Eina_Bool
_eldbus_model_private_get(Eo *obj EINA_UNUSED, Eldbus_Model_Data *pd)
{
   return pd->private;
}

static Eldbus_Connection_Type
_eldbus_model_type_get(Eo *obj EINA_UNUSED, Eldbus_Model_Data *pd)
{
   return pd->type;
}
...
static Eina_Value *
_eldbus_model_efl_model_property_get(Eo *obj,
                                     Eldbus_Model_Data *pd,
                                     const char *property)
{
...
static Eina_Array *
_eldbus_model_efl_model_properties_get(Eo *obj EINA_UNUSED,
                                       Eldbus_Model_Data *pd EINA_UNUSED)
{
   Eina_Array *r;
...
static unsigned int
_eldbus_model_efl_model_children_count_get(Eo *obj EINA_UNUSED,
                                           Eldbus_Model_Data *pd EINA_UNUSED)
{
   return 0;
}
