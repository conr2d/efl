...
DEFINE_EVAS_CALLBACKS(_legacy_evas_callback_table, EVAS_CALLBACK_LAST,
                      ...
                      EFL_EVENT_FOCUS_IN,
                      EFL_EVENT_FOCUS_OUT,
                      EFL_GFX_OBJECT_EVENT_SHOW,
                      EFL_GFX_OBJECT_EVENT_HIDE,
                      EFL_GFX_OBJECT_EVENT_MOVE,
                      EFL_GFX_OBJECT_EVENT_RESIZE,
                      EFL_GFX_OBJECT_EVENT_RESTACK,
                      EVAS_OBJECT_EVENT_DEL,
                      EFL_EVENT_HOLD,
                      EFL_GFX_OBJECT_EVENT_CHANGE_SIZE_HINTS,
