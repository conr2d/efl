...
EOLIAN static Eina_Bool
_evas_canvas_efl_canvas_scene_image_max_size_get(Eo *eo_e EINA_UNUSED, Evas_Public_Data *e, Eina_Size2D *max)
{
   int w = 0, h = 0;
...
EOLIAN Eina_Bool
_evas_canvas_efl_canvas_scene_smart_objects_calculating_get(Eo *eo_e EINA_UNUSED, Evas_Public_Data *e)
{
