...
EOLIAN static void
_evas_table_efl_gfx_object_size_set(Eo *obj, Evas_Table_Data *_pd EINA_UNUSED, Eina_Size2D sz)
{
...
EOLIAN static void
_evas_table_efl_gfx_object_position_set(Eo *obj, Evas_Table_Data *_pd EINA_UNUSED, Eina_Position2D pos)
{
