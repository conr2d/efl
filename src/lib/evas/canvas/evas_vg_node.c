...
static void
_efl_canvas_vg_node_efl_gfx_object_position_set(Eo *obj EINA_UNUSED, Efl_Canvas_Vg_Node_Data *pd, Eina_Position2D pos)
{
   pd->x = (double) pos.x;
   pd->y = (double) pos.y;
...
_efl_canvas_vg_node_efl_gfx_object_position_get(Eo *obj EINA_UNUSED, Efl_Canvas_Vg_Node_Data *pd)
{
...
static void
_efl_canvas_vg_node_efl_gfx_object_visible_set(Eo *obj EINA_UNUSED,
...
static Eina_Bool
_efl_canvas_vg_node_efl_gfx_object_visible_get(Eo *obj EINA_UNUSED,
                                      Efl_Canvas_Vg_Node_Data *pd)
{
...
static Eina_Size2D
_efl_canvas_vg_node_efl_gfx_object_size_get(Eo *obj, Efl_Canvas_Vg_Node_Data *pd EINA_UNUSED)
{
   Eina_Rect r;
...
_efl_canvas_vg_node_efl_gfx_object_geometry_get(Eo *obj, Efl_Canvas_Vg_Node_Data *pd EINA_UNUSED)
{
   Eina_Rect r;
   r.pos = efl_gfx_object_position_get(obj);
...
{
   return efl_gfx_object_visible_get(obj);
}

EAPI void
evas_vg_node_visible_set(Eo *obj, Eina_Bool v)
{
   efl_gfx_object_visible_set(obj, v);
}
...
evas_vg_node_geometry_set(Eo *obj, int x, int y, int w, int h)
{
   ...
   efl_gfx_object_size_set(obj, EINA_SIZE2D(w,  h));
}
