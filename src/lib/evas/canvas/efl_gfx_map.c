...
EFL_CALLBACKS_ARRAY_DEFINE(_geometry_changes,
                           { EFL_GFX_OBJECT_EVENT_MOVE, _geometry_changed_cb },
                           { EFL_GFX_OBJECT_EVENT_RESIZE, _geometry_changed_cb });
...
EFL_CALLBACKS_ARRAY_DEFINE(_pivot_changes,
                           { EFL_GFX_OBJECT_EVENT_MOVE, _pivot_changed_cb },
                           { EFL_GFX_OBJECT_EVENT_RESIZE, _pivot_changed_cb });
   ...
   EINA_INLIST_FOREACH(pd->cow->pivots, pivot)
     {
        ...
        if (!pivot->is_canvas)
          {
             pivot->geometry = efl_gfx_object_geometry_get(pivot->eo_obj);
          }
        else
          {
             ...
             if (pivot->is_evas)
               ...
               pivot->geometry.size = efl_gfx_object_size_get(pivot->eo_obj);
             pivot->geometry.x = 0;
             pivot->geometry.y = 0;
          }
     }
...
_gfx_map_op_add(Eo *eo_obj, Efl_Gfx_Map_Data *pd, Gfx_Map_Op_Type type,
                const Efl_Gfx_Object *eo_pivot, double cx, double cy, double cz,
                Eina_Bool is_absolute)
{
...
_map_rotate(Eo *eo_obj, Efl_Gfx_Map_Data *pd,
            double degrees, const Efl_Gfx_Object *pivot, double cx, double cy,
            Eina_Bool absolute)
{
   Gfx_Map_Op *op;
...
_map_rotate_3d(Eo *eo_obj, Efl_Gfx_Map_Data *pd,
               double dx, double dy, double dz,
               const Efl_Gfx_Object *pivot, double cx, double cy, double cz,
               Eina_Bool absolute)
{
   Gfx_Map_Op *op;
...
_map_zoom(Eo *eo_obj, Efl_Gfx_Map_Data *pd,
          ...
          const Efl_Gfx_Object *pivot, double cx, double cy,
          Eina_Bool absolute)
{
   Gfx_Map_Op *op;
...
_map_lightning_3d(Eo *eo_obj, Efl_Gfx_Map_Data *pd,
                  const Efl_Gfx_Object *pivot, double lx, double ly, double lz,
...
_map_perspective_3d(Eo *eo_obj, Efl_Gfx_Map_Data *pd,
                    const Efl_Gfx_Object *pivot, double px, double py,
