...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_async_start(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_async_cancel(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_dpi_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, double dpi)
{
...
_efl_canvas_image_efl_loadable_image_load_dpi_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_size_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, Eina_Size2D sz)
{
...
_efl_canvas_image_efl_loadable_image_load_size_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
   Eina_Size2D sz;
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_scale_down_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, int scale_down)
{
...
EOLIAN static int
_efl_canvas_image_efl_loadable_image_load_scale_down_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_skip_header_set(Eo *eo_obj, void *_pd EINA_UNUSED, Eina_Bool skip)
{
...
EOLIAN static Eina_Bool
_efl_canvas_image_efl_loadable_image_load_skip_header_get(Eo *eo_obj, void *_pd EINA_UNUSED)
{
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_region_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, Eina_Rect region)
{
...
_efl_canvas_image_efl_loadable_image_load_region_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
   Eina_Rect r;
...
EOLIAN static void
_efl_canvas_image_efl_loadable_image_load_orientation_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, Eina_Bool enable)
{
...
EOLIAN static Eina_Bool
_efl_canvas_image_efl_loadable_image_load_orientation_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static Eina_Bool
_efl_canvas_image_efl_loadable_image_load_region_support_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static Eina_Bool
_efl_canvas_image_efl_animated_image_animated_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static int
_efl_canvas_image_efl_animated_image_animated_frame_count_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
   return _evas_image_animated_frame_count_get(eo_obj);
}

Efl_Animated_Image_Loop_Hint
_evas_image_animated_loop_type_get(const Eo *eo_obj)
{
   ...
   if (!ENFN->image_animated_loop_type_get ||
       !evas_object_image_animated_get(eo_obj))
     return EFL_ANIMATED_IMAGE_LOOP_HINT_NONE;

   return (Efl_Animated_Image_Loop_Hint) ENFN->image_animated_loop_type_get(ENC, o->engine_data);
}

EOLIAN static Efl_Animated_Image_Loop_Hint
_efl_canvas_image_efl_animated_image_animated_loop_type_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static int
_efl_canvas_image_efl_animated_image_animated_loop_count_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
...
EOLIAN static double
_efl_canvas_image_efl_animated_image_animated_frame_duration_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, int start_frame, int frame_num)
{
...
EOLIAN static Eina_Bool
_efl_canvas_image_efl_animated_image_animated_frame_set(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED, int frame_index)
{
...
EOLIAN static int
_efl_canvas_image_efl_animated_image_animated_frame_get(Eo *eo_obj, void *_pd EINA_UNUSED EINA_UNUSED)
{
