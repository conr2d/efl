...
EOLIAN void
_efl_canvas_layout_efl_gfx_object_scale_set(Eo *obj EINA_UNUSED, Edje *ed, double scale)
{
   Edje *ged;
   Evas_Object *o;
   Eina_List *l;
...
EOLIAN double
_efl_canvas_layout_efl_gfx_object_scale_get(Eo *obj EINA_UNUSED, Edje *ed)
{
...
Eina_Bool
_edje_efl_text_container_text_set(Eo *obj, Edje *ed, const char *part, const char *text,
...
const char *
_edje_efl_text_container_text_get(Eo *obj EINA_UNUSED, Edje *ed, const char *part,
             ...
             if (legacy)
             ...
             else
               {
                  if (get_markup)
                    ...
                    {
                       entry = efl_text_container_text_get(rp->object);
                    }
               }
...
Eina_Bool
_edje_efl_content_content_set(Edje *ed, const char *part, Efl_Gfx_Object *obj_swallow)
{
...
edje_object_part_text_set(const Edje_Object *obj, const char *part, const char *text)
{
   ...
   _edje_efl_text_container_text_set((Eo *) obj, ed, part, text, EINA_TRUE, EINA_FALSE);
   return EINA_TRUE;
}
...
edje_object_part_text_get(const Edje_Object *obj, const char *part)
{
   ...
   return _edje_efl_text_container_text_get((Eo *)obj, ed, part, EINA_TRUE, EINA_FALSE);
}
