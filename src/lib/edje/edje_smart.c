...
EOLIAN static void
_efl_canvas_layout_efl_gfx_object_position_set(Eo *obj, Edje *ed, Eina_Position2D pos)
{
   unsigned short i;
...
EOLIAN static void
_efl_canvas_layout_efl_gfx_object_size_set(Eo *obj, Edje *ed, Eina_Size2D sz)
{
...
EOLIAN static void
_efl_canvas_layout_efl_gfx_object_visible_set(Eo *obj, Edje *ed, Eina_Bool vis)
{
