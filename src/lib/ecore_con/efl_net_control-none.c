...
_efl_net_control_manager_radios_offline_get(Eo *obj EINA_UNUSED, Efl_Net_Control_Manager_Data *pd EINA_UNUSED)
{
   return EINA_FALSE;
}

EOLIAN static Efl_Net_Control_State
_efl_net_control_manager_state_get(Eo *obj EINA_UNUSED, Efl_Net_Control_Manager_Data *pd EINA_UNUSED)
{
   return EFL_NET_CONTROL_STATE_ONLINE; /* best default for unsupported, hope we're online */
}

EOLIAN static Eina_Iterator *
_efl_net_control_manager_access_points_get(Eo *obj EINA_UNUSED, Efl_Net_Control_Manager_Data *pd EINA_UNUSED)
{
   return eina_list_iterator_new(NULL);
}

EOLIAN static Eina_Iterator *
_efl_net_control_manager_technologies_get(Eo *obj EINA_UNUSED, Efl_Net_Control_Manager_Data *pd EINA_UNUSED)
{
   return eina_list_iterator_new(NULL);
}
...
EOLIAN static Eina_Bool
_efl_net_control_manager_agent_enabled_get(Eo *obj EINA_UNUSED, Efl_Net_Control_Manager_Data *pd EINA_UNUSED)
{
   return EINA_FALSE;
}
