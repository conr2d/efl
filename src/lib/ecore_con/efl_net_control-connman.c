...
_efl_net_control_manager_radios_offline_get(Eo *o EINA_UNUSED, Efl_Net_Control_Manager_Data *pd)
{
   return pd->radios_offline;
}

EOLIAN static Efl_Net_Control_State
_efl_net_control_manager_state_get(Eo *o EINA_UNUSED, Efl_Net_Control_Manager_Data *pd)
{
   return pd->state;
}

EOLIAN static Eina_Iterator *
_efl_net_control_manager_access_points_get(Eo *o EINA_UNUSED, Efl_Net_Control_Manager_Data *pd)
{
   return eina_list_iterator_new(pd->access_points);
}

EOLIAN static Eina_Iterator *
_efl_net_control_manager_technologies_get(Eo *o EINA_UNUSED, Efl_Net_Control_Manager_Data *pd)
{
...
EOLIAN static Eina_Bool
_efl_net_control_manager_agent_enabled_get(Eo *o EINA_UNUSED, Efl_Net_Control_Manager_Data *pd)
{
