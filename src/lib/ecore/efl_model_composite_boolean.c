...
static unsigned int
_efl_model_composite_boolean_children_index_get(Eo *obj EINA_UNUSED,
                                                Efl_Model_Composite_Boolean_Children_Data *pd)
{
   return pd->index;
}
...
static Eina_Array *
_efl_model_composite_boolean_children_efl_model_properties_get(Eo *obj,
                                                               Efl_Model_Composite_Boolean_Children_Data *pd)
{
   Eina_Iterator *it;
   Eina_Stringshare *s;
...
static Eina_Value *
_efl_model_composite_boolean_children_efl_model_property_get(Eo *obj,
                                                             Efl_Model_Composite_Boolean_Children_Data *pd,
                                                             const char *property)
{
