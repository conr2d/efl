...
_efl_canvas_video_efl_loadable_image_load_size_get(Eo *obj EINA_UNUSED, Efl_Canvas_Video_Data *sd)
{
...
EOLIAN static void
_efl_canvas_video_efl_gfx_object_position_set(Evas_Object *obj, Efl_Canvas_Video_Data *sd, Eina_Position2D pos)
{
   Eina_Size2D sz;
   ...
   sz = efl_gfx_object_size_get(obj);
   _clipper_position_size_update(obj, pos.x, pos.y, sz.w, sz.h, sd->video.w, sd->video.h);
}

EOLIAN static void
_efl_canvas_video_efl_gfx_object_size_set(Evas_Object *obj, Efl_Canvas_Video_Data *sd, Eina_Size2D sz)
{
