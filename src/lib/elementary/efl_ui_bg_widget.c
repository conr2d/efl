...
elm_bg_load_size_set(Evas_Object *obj, int w, int h)
{
   ...
   efl_loadable_image_load_size_set(sd->img, EINA_SIZE2D(w, h));
}

EOLIAN static void
_efl_ui_bg_widget_efl_loadable_image_load_size_set(Eo *obj EINA_UNUSED, Efl_Ui_Bg_Widget_Data *sd, Eina_Size2D sz)
{
   efl_loadable_image_load_size_set(sd->img, sz);
}

EOLIAN static Eina_Size2D
_efl_ui_bg_widget_efl_loadable_image_load_size_get(Eo *obj EINA_UNUSED, Efl_Ui_Bg_Widget_Data *sd)
{
   return efl_loadable_image_load_size_get(sd->img);
}
