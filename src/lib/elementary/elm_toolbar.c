...
_internal_elm_toolbar_icon_size_get(Evas_Object *obj)
{
   ...
   if (icon_size)
     return (int)(atoi(icon_size) * efl_gfx_object_scale_get(obj) * elm_config_scale_get()
...
_elm_toolbar_efl_ui_widget_theme_apply(Eo *obj, Elm_Toolbar_Data *sd)
{
   ...
   scale = (efl_gfx_object_scale_get(obj) * elm_config_scale_get());
   EINA_INLIST_FOREACH(sd->items, it)
...
EOLIAN static void
_elm_toolbar_efl_gfx_object_position_set(Eo *obj, Elm_Toolbar_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_toolbar_efl_gfx_object_size_set(Eo *obj, Elm_Toolbar_Data *sd, Eina_Size2D sz)
{
...
EOLIAN static const char*
_elm_toolbar_item_efl_access_object_i18n_name_get(Eo *eo_item, Elm_Toolbar_Item_Data *item)
{
   const char *ret;
...
_elm_toolbar_item_efl_access_object_state_set_get(Eo *eo_it, Elm_Toolbar_Item_Data *item EINA_UNUSED)
{
...
_elm_toolbar_efl_access_object_access_children_get(Eo *obj EINA_UNUSED, Elm_Toolbar_Data *sd)
{
...
EOLIAN static Efl_Access_State_Set
_elm_toolbar_efl_access_object_state_set_get(Eo *obj, Elm_Toolbar_Data *sd EINA_UNUSED)
{
