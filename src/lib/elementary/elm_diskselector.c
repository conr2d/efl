...
EOLIAN static void
_elm_diskselector_efl_gfx_object_position_set(Eo *obj, Elm_Diskselector_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_diskselector_efl_gfx_object_size_set(Eo *obj, Elm_Diskselector_Data *sd, Eina_Size2D sz)
{
