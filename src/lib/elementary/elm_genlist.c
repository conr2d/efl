...
EOLIAN static void
_elm_genlist_pan_efl_gfx_object_position_set(Eo *obj, Elm_Genlist_Pan_Data *psd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_genlist_pan_efl_gfx_object_size_set(Eo *obj, Elm_Genlist_Pan_Data *psd, Eina_Size2D size)
{
   Elm_Genlist_Data *sd = psd->wsd;
   Eina_Size2D old;
   ...
   old = efl_gfx_object_size_get(obj);
...
super:
   efl_gfx_object_size_set(efl_super(obj, MY_PAN_CLASS), size);
}
                           ...
                           Eina_Bool effect_on)
{
   ...
   edje_object_scale_set(it->deco_all_view, efl_gfx_object_scale_get(WIDGET(it)) *
                         elm_config_scale_get());
...
EOLIAN static void
_elm_genlist_efl_gfx_object_position_set(Eo *obj, Elm_Genlist_Data *sd, Eina_Position2D pos)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_MOVE, 0, pos.x, pos.y))
     return;
...
EOLIAN static void
_elm_genlist_efl_gfx_object_size_set(Eo *obj, Elm_Genlist_Data *sd, Eina_Size2D sz)
{
