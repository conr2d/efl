...
EOLIAN static int
_efl_access_object_index_in_parent_get(Eo *obj, Efl_Access_Object_Data *pd EINA_UNUSED)
{
...
EOLIAN Eina_List*
_efl_access_object_attributes_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
...
EOLIAN static void
_efl_access_object_attribute_append(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED, const char *key, const char *value)
{
   Eina_List *l;
...
_efl_access_object_reading_info_type_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd)
{
   return pd->reading_info;
}

EOLIAN static Efl_Access_Role
_efl_access_object_role_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
   return pd->role;
}

EOLIAN static void
_efl_access_object_role_set(Eo *obj, Efl_Access_Object_Data *pd EINA_UNUSED, Efl_Access_Role role)
{
   if (pd->role != role)
     {
        pd->role = role;
...
EOLIAN const char *
_efl_access_object_role_name_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
   Efl_Access_Role role;
...
EOLIAN const char *
_efl_access_object_i18n_name_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd)
{
#ifdef ENABLE_NLS
...
const char * _efl_access_object_description_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd)
{
#ifdef ENABLE_NLS
   if (pd->translation_domain)
...
_efl_access_object_localized_role_name_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
   const char *ret = NULL;
...
_efl_access_object_access_children_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
...
_efl_access_object_state_set_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
   return 0;
}

EOLIAN Efl_Access_Relation_Set
_efl_access_object_relation_set_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd EINA_UNUSED)
{
...
EOLIAN const char*
_efl_access_object_translation_domain_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd)
{
...
EOLIAN Eo*
_efl_access_object_access_root_get(Eo *class EINA_UNUSED, void *pd EINA_UNUSED)
{
   if (!root)
...
_efl_access_object_access_type_get(Eo *obj EINA_UNUSED, Efl_Access_Object_Data *pd)
{
   return pd->type;
}
