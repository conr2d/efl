...
EOLIAN static void
_efl_ui_view_list_efl_gfx_object_position_set(Eo *obj, Efl_Ui_View_List_Data *pd, Eina_Position2D pos)
{
...
EOLIAN static void
_efl_ui_view_list_efl_gfx_object_size_set(Eo *obj, Efl_Ui_View_List_Data *pd, Eina_Size2D size)
{
...
_efl_ui_view_list_efl_canvas_group_group_add(Eo *obj, Efl_Ui_View_List_Data *pd)
{
   ...
   efl_gfx_object_visible_set(pd->pan_obj, EINA_TRUE);
...
EOLIAN Eina_List*
_efl_ui_view_list_efl_access_object_access_children_get(Eo *obj, Efl_Ui_View_List_Data *pd)
{
