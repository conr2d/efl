...
_item_cache_add(Elm_Gen_Item *it, Eina_List *contents)
{
   ...
   edje_object_scale_set(VIEW(it),
                         efl_gfx_object_scale_get(WIDGET(it))
...
EOLIAN static void
_elm_gengrid_pan_efl_gfx_object_position_set(Eo *obj, Elm_Gengrid_Pan_Data *psd, Eina_Position2D pos)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_MOVE, 0, pos.x, pos.y))
     return;

   efl_gfx_object_position_set(efl_super(obj, MY_PAN_CLASS), pos);
...
EOLIAN static void
_elm_gengrid_pan_efl_gfx_object_size_set(Eo *obj, Elm_Gengrid_Pan_Data *psd, Eina_Size2D sz)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_RESIZE, 0, sz.w, sz.h))
     return;

   efl_gfx_object_size_set(efl_super(obj, MY_PAN_CLASS), sz);
...
_view_style_update(Elm_Gen_Item *it, Evas_Object *view, const char *style)
{
   ...
   edje_object_scale_set(view, efl_gfx_object_scale_get(WIDGET(it)) *
                         elm_config_scale_get());
...
EOLIAN static void
_elm_gengrid_efl_gfx_object_position_set(Eo *obj, Elm_Gengrid_Data *sd, Eina_Position2D pos)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_MOVE, 0, pos.x, pos.y))
     return;
...
EOLIAN static void
_elm_gengrid_efl_gfx_object_size_set(Eo *obj, Elm_Gengrid_Data *sd, Eina_Size2D sz)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_RESIZE, 0, sz.w, sz.h))
     return;
...
_elm_gengrid_item_efl_access_object_state_set_get(Eo *eo_it, Elm_Gen_Item *it EINA_UNUSED)
{
...
EOLIAN const char*
_elm_gengrid_item_efl_access_object_i18n_name_get(Eo *eo_it, Elm_Gen_Item *it)
{
   const char *ret;
   Eina_Strbuf *buf;
...
EOLIAN Eina_List*
_elm_gengrid_efl_access_object_access_children_get(Eo *obj, Elm_Gengrid_Data *sd)
{
...
EOLIAN Efl_Access_State_Set
_elm_gengrid_efl_access_object_state_set_get(Eo *obj, Elm_Gengrid_Data *sd EINA_UNUSED)
{
   Efl_Access_State_Set ret;
