...
EOLIAN static void
_elm_mapbuf_efl_gfx_object_position_set(Eo *obj, Elm_Mapbuf_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_mapbuf_efl_gfx_object_size_set(Eo *obj, Elm_Mapbuf_Data *sd, Eina_Size2D sz)
{
   ...
   if (sd->content)
     efl_gfx_object_size_set(sd->content, sz);
...
EOLIAN static void
_elm_mapbuf_efl_gfx_object_visible_set(Eo *obj, Elm_Mapbuf_Data *sd, Eina_Bool vis)
{
