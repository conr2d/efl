...
EOLIAN static void
_elm_pan_efl_gfx_object_position_set(Eo *obj, Elm_Pan_Smart_Data *psd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_pan_efl_gfx_object_size_set(Eo *obj EINA_UNUSED, Elm_Pan_Smart_Data *psd, Eina_Size2D sz)
{
...
EOLIAN static void
_elm_pan_efl_gfx_object_visible_set(Eo *obj, Elm_Pan_Smart_Data *psd, Eina_Bool vis)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_VISIBLE, 0, vis))
     return;

   efl_gfx_object_visible_set(efl_super(obj, MY_PAN_CLASS), vis);
...
_elm_scroll_scroll_bar_auto_visibility_adjust(Elm_Scrollable_Smart_Interface_Data *sid)
{
   ...
   w = sid->content_info.w;
   h = sid->content_info.h;
   sz = efl_gfx_object_size_get(sid->edje_obj);
