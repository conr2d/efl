                                     ...
                                     Efl_Ui_Scroller_Data *sd EINA_UNUSED)
{
   ...
   efl_event_callback_add(obj, EFL_GFX_OBJECT_EVENT_RESIZE,
                          _efl_ui_scroller_resized_cb, obj);
   efl_event_callback_add(obj, EFL_GFX_OBJECT_EVENT_CHANGE_SIZE_HINTS,
                          _efl_ui_scroller_size_hint_changed_cb, obj);
   efl_event_callback_add(sd->pan_obj, EFL_GFX_OBJECT_EVENT_RESIZE,
                                       ...
                                       Efl_Ui_Scroller_Data *sd EINA_UNUSED)
{
   ...
   efl_event_callback_del(obj, EFL_UI_SCROLLBAR_EVENT_BAR_HIDE,
                          _efl_ui_scroller_bar_hide_cb, obj);
   efl_event_callback_del(obj, EFL_GFX_OBJECT_EVENT_RESIZE,
                          _efl_ui_scroller_resized_cb, obj);
   efl_event_callback_del(obj, EFL_GFX_OBJECT_EVENT_CHANGE_SIZE_HINTS,
                          _efl_ui_scroller_size_hint_changed_cb, obj);
   efl_event_callback_del(sd->pan_obj, EFL_GFX_OBJECT_EVENT_RESIZE,
                          _efl_ui_scroller_pan_resized_cb, obj);
   efl_del(sd->pan_obj);
   sd->pan_obj = NULL;
   efl_del(sd->smanager);
...
_efl_ui_scroller_elm_layout_sizing_eval(Eo *obj, Efl_Ui_Scroller_Data *sd)
{
   ...
   if (sd->content) efl_gfx_object_size_set(sd->content, EINA_SIZE2D(view.w, view.h));
