...
{
   efl_gfx_object_visible_set(data, EINA_FALSE);
...
_elm_popup_efl_access_object_state_set_get(Eo *obj, Elm_Popup_Data *sd EINA_UNUSED)
{
...
EOLIAN static const char*
_elm_popup_efl_access_object_i18n_name_get(Eo *obj, Elm_Popup_Data *sd)
{
