...
_sizing_eval(Evas_Object *obj)
{
   ...
   efl_gfx_object_geometry_set(sd->location, EINA_RECT(x_p, y_p, bw, h_p));
        ...
        EINA_LIST_FOREACH(l, _l, eo_item)
          {
             ...
             edje_object_scale_set
               (VIEW(item), efl_gfx_object_scale_get(obj) *
...
EOLIAN static void
_elm_menu_efl_gfx_object_visible_set(Eo *obj EINA_UNUSED, Elm_Menu_Data *sd, Eina_Bool vis)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_VISIBLE, 0, vis))
     return;

   efl_gfx_object_visible_set(efl_super(obj, MY_CLASS), vis);
   if (vis) efl_gfx_object_visible_set(sd->hv, EINA_TRUE);
}
...
_elm_menu_efl_access_object_access_children_get(Eo *obj, Elm_Menu_Data *sd)
{
   Eina_List *ret;
...
EOLIAN static Eina_List*
_elm_menu_item_efl_access_object_access_children_get(Eo *obj EINA_UNUSED, Elm_Menu_Item_Data *sd)
{
...
_elm_menu_item_efl_access_object_role_get(Eo *obj EINA_UNUSED, Elm_Menu_Item_Data *sd)
{
   return sd->submenu.items ? EFL_ACCESS_ROLE_MENU : EFL_ACCESS_ROLE_MENU_ITEM;
}

EOLIAN static const char*
_elm_menu_item_efl_access_object_i18n_name_get(Eo *obj, Elm_Menu_Item_Data *sd)
{
   const char *ret;
...
_elm_menu_item_efl_access_object_state_set_get(Eo *obj EINA_UNUSED, Elm_Menu_Item_Data *sd)
{
