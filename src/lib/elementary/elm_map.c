...
EOLIAN static void
_elm_map_pan_efl_gfx_object_size_set(Eo *obj, Elm_Map_Pan_Data *psd, Eina_Size2D sz)
{
...
EOLIAN static void
_elm_map_pan_efl_gfx_object_position_set(Eo *obj, Elm_Map_Pan_Data *_pd EINA_UNUSED, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_map_efl_gfx_object_position_set(Eo *obj, Elm_Map_Data *sd, Eina_Position2D pos)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_MOVE, 0, pos.x, pos.y))
     return;
...
EOLIAN static void
_elm_map_efl_gfx_object_size_set(Eo *obj, Elm_Map_Data *sd, Eina_Size2D sz)
{
   if (_evas_object_intercept_call(obj, EVAS_OBJECT_INTERCEPT_CB_RESIZE, 0, sz.w, sz.h))
     return;
