...
_sizing_eval(Evas_Object *obj)
{
   ...
   scale = (sd->size * efl_gfx_object_scale_get(obj) * elm_config_scale_get());
...
_elm_photo_efl_ui_widget_theme_apply(Eo *obj, Elm_Photo_Data *sd)
{
   ...
   elm_object_scale_set(sd->icon, efl_gfx_object_scale_get(obj));
...
_elm_photo_efl_canvas_group_group_add(Eo *obj, Elm_Photo_Data *priv)
{
   ...
   elm_object_scale_set(priv->icon, efl_gfx_object_scale_get(obj));
