...
EOLIAN static void
_efl_ui_layout_object_efl_file_file_get(Eo *obj, Efl_Ui_Layout_Object_Data *sd EINA_UNUSED, const char **file, const char **group)
{
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd);
   edje_object_file_get(wd->resize_obj, file, group);
}
...
EOLIAN static void
_efl_ui_layout_object_efl_file_mmap_get(Eo *obj, Efl_Ui_Layout_Object_Data *sd EINA_UNUSED, const Eina_File **file, const char **group)
{
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd);
...
_efl_ui_layout_object_efl_layout_group_group_data_get(Eo *obj, Efl_Ui_Layout_Object_Data *_pd EINA_UNUSED, const char *key)
{
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd, NULL);
...
_efl_ui_layout_object_efl_layout_group_group_size_min_get(Eo *obj, Efl_Ui_Layout_Object_Data *_pd EINA_UNUSED)
{
...
EOLIAN static Eina_Size2D
_efl_ui_layout_object_efl_layout_group_group_size_max_get(Eo *obj, Efl_Ui_Layout_Object_Data *_pd EINA_UNUSED)
{
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd, EINA_SIZE2D(0, 0));
...
EOLIAN static Eina_Bool
_efl_ui_layout_object_efl_layout_group_part_exist_get(Eo *obj, Efl_Ui_Layout_Object_Data *_pd EINA_UNUSED, const char *part)
{
   ELM_WIDGET_DATA_GET_OR_RETURN(obj, wd, EINA_FALSE);
...
_efl_ui_layout_object_efl_ui_view_model_get(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Object_Data *pd)
{
   return pd->model;
}
...
ELM_PART_OVERRIDE_TEXT_CONTAINER_TEXT_GET_FULL(efl_ui_layout_part_text, efl_ui_layout, EFL_UI_LAYOUT_OBJECT, Efl_Ui_Layout_Object_Data)
ELM_PART_OVERRIDE_TEXT_CONTAINER_TEXT_SET_FULL(efl_ui_layout_part_text, efl_ui_layout, EFL_UI_LAYOUT_OBJECT, Efl_Ui_Layout_Object_Data)
...
ELM_PART_OVERRIDE_TEXT_CONTAINER_TEXT_GET_FULL(efl_ui_layout_part_legacy, efl_ui_layout, EFL_UI_LAYOUT_OBJECT, Efl_Ui_Layout_Object_Data)
ELM_PART_OVERRIDE_TEXT_CONTAINER_TEXT_SET_FULL(efl_ui_layout_part_legacy, efl_ui_layout, EFL_UI_LAYOUT_OBJECT, Efl_Ui_Layout_Object_Data)
