...
EOLIAN static void
_elm_entry_efl_gfx_object_position_set(Eo *obj, Elm_Entry_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_entry_efl_gfx_object_size_set(Eo *obj, Elm_Entry_Data *sd, Eina_Size2D sz)
{
...
EOLIAN static void
_elm_entry_efl_gfx_object_visible_set(Eo *obj, Elm_Entry_Data *sd, Eina_Bool vis)
{
...
_elm_entry_efl_access_object_state_set_get(Eo *obj, Elm_Entry_Data *_pd EINA_UNUSED)
{
...
EOLIAN static const char*
_elm_entry_efl_access_object_i18n_name_get(Eo *obj, Elm_Entry_Data *sd)
{
   const char *name;
