...
EOLIAN static void
_elm_hover_efl_gfx_object_position_set(Eo *obj, Elm_Hover_Data *_pd EINA_UNUSED, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_hover_efl_gfx_object_size_set(Eo *obj, Elm_Hover_Data *_pd EINA_UNUSED, Eina_Size2D sz)
{
...
EOLIAN static void
_elm_hover_efl_gfx_object_visible_set(Eo *obj, Elm_Hover_Data *pd EINA_UNUSED, Eina_Bool vis)
{
...
_elm_hover_efl_access_object_state_set_get(Eo *obj, Elm_Hover_Data *pd EINA_UNUSED)
{
