...
EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_unpack(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj)
{
   return _efl_ui_layout_box_remove(pd->obj, pd->sd, pd->part, subobj) != NULL;
}

EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_container_content_remove(Eo *obj, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *content)
{
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_pack(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj)
{
   return _efl_ui_layout_box_append(pd->obj, pd->sd, pd->part, subobj);
}

EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_linear_pack_begin(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj)
{
   return _efl_ui_layout_box_prepend(pd->obj, pd->sd, pd->part, subobj);
}

EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_linear_pack_end(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj)
{
   return _efl_ui_layout_box_append(pd->obj, pd->sd, pd->part, subobj);
}

EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_linear_pack_before(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj, const Efl_Gfx_Object *existing)
{
   return _efl_ui_layout_box_insert_before(pd->obj, pd->sd, pd->part, subobj, existing);
}

EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_linear_pack_after(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj, const Efl_Gfx_Object *existing)
{
   const Efl_Gfx_Object *other;
   int index;
   Eo *pack = (Eo *) edje_object_part_object_get(pd->obj, pd->part);
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_box_efl_pack_linear_pack_at(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, Efl_Gfx_Object *subobj, int index)
{
...
EOLIAN static int
_efl_ui_layout_part_box_efl_pack_linear_pack_index_get(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Box_Data *pd, const Efl_Gfx_Object *subobj)
{
   Eo *pack = (Eo *) edje_object_part_object_get(pd->obj, pd->part);
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_table_efl_pack_unpack(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Table_Data *pd, Efl_Gfx_Object *subobj)
{
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_table_efl_container_content_remove(Eo *obj, Efl_Ui_Layout_Table_Data *pd, Efl_Gfx_Object *content)
{
   // alias for efl_pack_unpack
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_table_efl_pack_table_pack_table(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Table_Data *pd, Efl_Gfx_Object *subobj, int col, int row, int colspan, int rowspan)
{
...
EOLIAN static Eina_Bool
_efl_ui_layout_part_table_efl_pack_table_table_position_get(Eo *obj EINA_UNUSED, Efl_Ui_Layout_Table_Data *pd, Efl_Gfx_Object * subobj, int *col, int *row, int *colspan, int *rowspan)
{
   unsigned short c, r, cs, rs;
   Eina_Bool ret;
   Eo *pack = (Eo *) edje_object_part_object_get(pd->obj, pd->part);
