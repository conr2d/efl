   ...
   EINA_LIST_FOREACH(sd->items, n, eo_it)
     {
        ...
        edje_object_scale_set
          (VIEW(it), efl_gfx_object_scale_get(obj) * elm_config_scale_get());
        it->fixed = EINA_FALSE;
     }
...
_elm_list_item_efl_access_object_state_set_get(Eo *eo_it, Elm_List_Item_Data *data EINA_UNUSED)
{
...
EOLIAN static const char*
_elm_list_item_efl_access_object_i18n_name_get(Eo *eo_it, Elm_List_Item_Data *data)
{
   const char *ret;
...
EOLIAN static void
_elm_list_efl_gfx_object_position_set(Eo *obj, Elm_List_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_list_efl_gfx_object_size_set(Eo *obj, Elm_List_Data *sd, Eina_Size2D sz)
{
...
EOLIAN Eina_List*
_elm_list_efl_access_object_access_children_get(Eo *obj, Elm_List_Data *pd)
{
   Eina_List *ret;
