...
EOLIAN static void
_elm_scroller_efl_gfx_object_position_set(Eo *obj, Elm_Scroller_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_scroller_efl_gfx_object_size_set(Eo *obj, Elm_Scroller_Data *sd, Eina_Size2D sz)
{
...
_focused_element(void *data, const Efl_Event *event)
{
   ...
   geom = efl_gfx_object_geometry_get(obj);
   geom.x = geom.y = 0;
