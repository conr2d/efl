...
_elm_index_efl_access_object_access_children_get(Eo *obj, Elm_Index_Data *data)
{
   Eina_List *ret;
...
EOLIAN static const char*
_elm_index_item_efl_access_object_i18n_name_get(Eo *eo_it, Elm_Index_Item_Data *data)
{
   const char *name;
