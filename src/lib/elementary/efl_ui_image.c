...
_efl_ui_image_efl_canvas_group_group_del(Eo *obj, Efl_Ui_Image_Data *sd)
{
   if (elm_widget_is_legacy(obj))
     efl_event_callback_del(obj, EFL_GFX_OBJECT_EVENT_CHANGE_SIZE_HINTS,
...
EOLIAN static void
_efl_ui_image_efl_gfx_object_position_set(Eo *obj, Efl_Ui_Image_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_efl_ui_image_efl_gfx_object_size_set(Eo *obj, Efl_Ui_Image_Data *sd, Eina_Size2D sz)
{
...
_efl_ui_image_show(Eo *obj, Efl_Ui_Image_Data *sd)
{
   ...
   efl_gfx_object_visible_set(sd->img, EINA_TRUE);
   _prev_img_del(sd);
}
...
_efl_ui_image_hide(Eo *obj, Efl_Ui_Image_Data *sd)
{
   ...
   efl_gfx_object_visible_set(sd->img, EINA_FALSE);
   _prev_img_del(sd);
}

EOLIAN static void
_efl_ui_image_efl_gfx_object_visible_set(Eo *obj, Efl_Ui_Image_Data *sd, Eina_Bool vis)
{
...
_efl_ui_image_sizing_eval(Evas_Object *obj)
{
   ...
   if (sd->no_scale)
     ...
     _efl_ui_image_internal_scale_set(obj, sd, efl_gfx_object_scale_get(obj) * elm_config_scale_get());
                       ...
                       int size)
{
   ...
   efl_loadable_image_load_size_set(obj, EINA_SIZE2D(size, size));
}

EOLIAN static void
_efl_ui_image_efl_loadable_image_load_size_set(Eo *obj, Efl_Ui_Image_Data *sd, Eina_Size2D sz)
{
   sd->load_size = sz;
   _efl_ui_image_load_size_set_internal(obj, sd);
}
...
elm_image_prescale_get(const Evas_Object *obj)
{
   ...
   sz = efl_loadable_image_load_size_get(obj);

   return MAX(sz.w, sz.h);
}

EOLIAN static Eina_Size2D
_efl_ui_image_efl_loadable_image_load_size_get(Eo *obj EINA_UNUSED, Efl_Ui_Image_Data *sd)
{
   return sd->load_size;
}
...
elm_image_add(Evas_Object *parent)
{
   ...
   efl_event_callback_add(obj, EFL_GFX_OBJECT_EVENT_CHANGE_SIZE_HINTS, _on_size_hints_changed, priv);
