...
EOLIAN static void
_elm_combobox_efl_gfx_object_visible_set(Eo *obj, Elm_Combobox_Data *sd, Eina_Bool vis)
{
...
_elm_combobox_efl_object_constructor(Eo *obj, Elm_Combobox_Data *sd)
{
   ...
   efl_gfx_object_visible_set(sd->hover, EINA_FALSE);
...
EOLIAN static void
_elm_combobox_efl_gfx_object_size_set(Eo *obj, Elm_Combobox_Data *pd, Eina_Size2D sz)
{
