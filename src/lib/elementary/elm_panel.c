...
EOLIAN static void
_elm_panel_efl_gfx_object_position_set(Eo *obj, Elm_Panel_Data *sd, Eina_Position2D pos)
{
...
EOLIAN static void
_elm_panel_efl_gfx_object_size_set(Eo *obj, Elm_Panel_Data *sd, Eina_Size2D sz)
{
