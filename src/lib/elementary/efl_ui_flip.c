...
static void
_content_added(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *content)
{
   evas_object_smart_member_add(content, obj);
...
static void
_content_removed(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *content)
{
   Efl_Gfx_Object *back_face, *cur_face, *face;
   int index, count;
   Eina_Bool state;
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_container_content_remove(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *content)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_unpack(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_pack(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_linear_pack_begin(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_linear_pack_end(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj)
{
   pd->content_list = eina_list_append(pd->content_list, subobj);
   _content_added(obj, pd, subobj);
   return EINA_TRUE;
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_linear_pack_before(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj, const Efl_Gfx_Object *existing)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_linear_pack_after(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj, const Efl_Gfx_Object *existing)
{
...
EOLIAN static Eina_Bool
_efl_ui_flip_efl_pack_linear_pack_at(Eo *obj, Efl_Ui_Flip_Data *pd, Efl_Gfx_Object *subobj, int index)
{
   Efl_Gfx_Object *existing = NULL;
...
{
   Efl_Gfx_Object *content = eina_list_nth(pd->content_list ,index);
...
EOLIAN static int
_efl_ui_flip_efl_pack_linear_pack_index_get(Eo *obj EINA_UNUSED, Efl_Ui_Flip_Data *pd, const Efl_Gfx_Object *subobj)
{
