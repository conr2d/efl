...
EOLIAN static void
_elm_naviframe_efl_gfx_object_visible_set(Eo *obj, Elm_Naviframe_Data *sd EINA_UNUSED, Eina_Bool vis)
{
...
_elm_naviframe_item_efl_access_object_access_children_get(Eo *eo_item EINA_UNUSED, Elm_Naviframe_Item_Data *nit)
{
   Eina_List *ret = NULL;
